...
public class DataComponentsInit {
	...
	public static final DeferredHolder<DataComponentType<?>, DataComponentType<Item>> ITEM = DATA_COMPONENTS
			.registerComponentType("item",
					builder -> builder.persistent(MachinaCodecs.ITEM).networkSynchronized(MachinaStreamCodecs.ITEM));
	...
	public static final DeferredHolder<DataComponentType<?>, DataComponentType<Fluid>> FLUID = DATA_COMPONENTS
			.registerComponentType("fluid",
					builder -> builder.persistent(MachinaCodecs.FLUID).networkSynchronized(MachinaStreamCodecs.FLUID));
