...
public class PlanetNoiseSurfaceBuilder extends SurfaceBuilder<SurfaceBuilderConfig> {

	private final BlockState[] states;

	public PlanetNoiseSurfaceBuilder(Codec<SurfaceBuilderConfig> c, BlockState... states) {
		super(c);
		this.states = states;
	}
	...
	public void apply(Random rand, IChunk chunk, Biome biome, int x, int z, int startHeight, double noise,
		...
		PlanetSurfaceBuilder.BASE.apply(rand, chunk, biome, x, z, startHeight, noise, defaultBlock,
