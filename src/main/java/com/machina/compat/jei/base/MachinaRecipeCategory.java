...
public class MachinaRecipeCategory<C extends RecipeInput> implements IRecipeCategory<MachinaRecipe<C>> {
    ...
    public MachinaRecipeCategory(IGuiHelper gui, RecipeRegistryObject<C> obj, DeferredBlock<? extends Block> block) {
        ...
        this.ticktimer = gui.createTickTimer(20, 3, false);
    }
    ...
    @Override
    public void draw(MachinaRecipe<C> recipe, @NotNull IRecipeSlotsView view, @NotNull GuiGraphics gui, double mx, double my) {
    ...
    public void setRecipe(@NotNull IRecipeLayoutBuilder builder, @NotNull MachinaRecipe<C> recipe,
        ...
        for (FluidStack fluid : ifluids) {
            ...
            builder.addSlot(RecipeIngredientRole.INPUT, x, y).setFluidRenderer(1, false, 16, 16)
                    .addFluidStack(fluid.getFluid(), (long) fluid.getAmount() * recipe.getPeriodicConsumption());
            i++;
        }
