...
public class VecUtil {
	...
	public static BlockElementRotation dirToBer(Direction dir, Vector3f origin) {
		return switch (dir) {
		case EAST -> new BlockElementRotation(origin, Direction.Axis.Y, 270, false);
		case SOUTH -> new BlockElementRotation(origin, Direction.Axis.X, 180, false);
		case WEST -> new BlockElementRotation(origin, Direction.Axis.Y, 90, false);
		case UP -> new BlockElementRotation(origin, Direction.Axis.X, 90, false);
		case DOWN -> new BlockElementRotation(origin, Direction.Axis.X, 270, false);
