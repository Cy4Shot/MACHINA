...
public class PressurizedChamberBlock extends HorizontalFacingBlock {

	public PressurizedChamberBlock() {
	...
	public TileEntity createTileEntity(BlockState state, IBlockReader world) {
		return TileEntityInit.PRESSURIZED_CHAMBER.get().create();
	}
	...
	public ActionResultType use(BlockState pState, World level, BlockPos pos, PlayerEntity player, Hand pHand,
		...
		if (!level.isClientSide()) {
			...
			if (te instanceof PressurizedChamberTileEntity)
				NetworkHooks.openGui((ServerPlayerEntity) player, (PressurizedChamberTileEntity) te, pos);
		}
