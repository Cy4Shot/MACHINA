...
public class MachinaSmithingRecipeBuilder {
	...
	public MachinaSmithingRecipeBuilder(IRecipeSerializer<?> pType, Ingredient pBase, Ingredient pAddition,
			Item pResult) {
		this.type = pType;
		this.base = pBase;
	...
	public static MachinaSmithingRecipeBuilder smithing(Ingredient pBase, Ingredient pAddition, Item pResult) {
		return new MachinaSmithingRecipeBuilder(IRecipeSerializer.SMITHING, pBase, pAddition, pResult);
	}

	public MachinaSmithingRecipeBuilder unlocks(String pName, ICriterionInstance pCriterion) {
	...
	public void save(Consumer<IFinishedRecipe> pFinishedRecipeConsumer, ResourceLocation pId) {
		...
		pFinishedRecipeConsumer.accept(new MachinaSmithingRecipeBuilder.Result(pId, this.type, this.base, this.addition,
