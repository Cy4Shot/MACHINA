...
public class ComposterVatRecipe extends MachinaRecipe<ComposterVatBlockEntity> {

	public ComposterVatRecipe(ResourceLocation loc, int energy, int time, float pressure, float temperature,
	...
	@Override
	public RecipeFactory<MachinaRecipe<ComposterVatBlockEntity>> getFactory() {
		return ComposterVatRecipe::new;
	}
}
