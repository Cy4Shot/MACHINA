...
public record PlanetType(ResourceLocation name, int iconY, int color, Shape shape, List<BiomePlacement> biomes, List<WeatherEvent> weathers, PlanetTraitSettings traits, BlockState base) {
