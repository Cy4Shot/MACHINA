    ...
    public LayerDefinition createBodyLayer() {
        ...
        PartDefinition Shields = partdefinition.addOrReplaceChild("Shields",
                CubeListBuilder.create().texOffs(0, 0)
                        .addBox(-14.0F, 12.0F, -14.0F, 28.0F, 4.0F, 28.0F, new CubeDeformation(0.0F)).texOffs(0, 32)
                        .addBox(-12.0F, 8.0F, -12.0F, 24.0F, 4.0F, 24.0F, new CubeDeformation(0.0F)).texOffs(0, 60)
                        .addBox(-10.0F, 4.0F, -10.0F, 20.0F, 4.0F, 20.0F, new CubeDeformation(0.0F)).texOffs(80, 60)
                        .addBox(-8.0F, 0.0F, -8.0F, 16.0F, 4.0F, 16.0F, new CubeDeformation(0.0F)),
                PartPose.ZERO);

        PartDefinition Corners2 = Shields.addOrReplaceChild("Corners2", CubeListBuilder.create(), PartPose.ZERO);
        ...
        PartDefinition Corner_r1 = Corners2.addOrReplaceChild("Corner_r1",
                ...
                PartPose.offsetAndRotation(-14.0F, 16.0F, 14.0F, 0.3927F, 0.0F, 0.3927F));
