package com.machina.util.color;
...
public class Color {
	...
	/**
	 * Returns a {@code float} array containing the color and alpha components of
	 * the {@code Color}, in the {@code ColorSpace} specified by the {@code cspace}
	 * parameter. If {@code compArray} is {@code null}, an array with length equal
	 * to the number of components in {@code cspace} plus one is created for the
	 * return value. Otherwise, {@code compArray} must have at least this length,
	 * and it is filled in with the components and returned.
	 * 
	...
	public float[] getComponents(ColorSpace cspace, float[] compArray) {
		...
		if (fvalue == null) {
			compArray[tmpout.length] = (getAlpha()) / 255f;
		} else {
	...
	/**
	 * Returns the transparency mode for this {@code Color}. This is required to
	 * implement the {@code Paint} interface.
	 * 
