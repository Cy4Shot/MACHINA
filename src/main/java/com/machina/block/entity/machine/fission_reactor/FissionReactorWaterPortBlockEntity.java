...
public class FissionReactorWaterPortBlockEntity extends MultiblockPartBlockEntity {

	public FissionReactorWaterPortBlockEntity(BlockPos pos, BlockState state) {
		super(BlockEntityInit.FISSION_REACTOR_WATER_PORT.get(), pos, state);
	}
	...
	public boolean isPort(MachinaCap cap) {
		return cap.equals(MachinaCap.FLUID);
	}
