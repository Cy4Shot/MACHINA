...
public class PlanetSurfaceBuilder extends SurfaceBuilder<SurfaceBuilderConfig> {

	public static final PlanetSurfaceBuilder BASE = new PlanetSurfaceBuilder(
			SurfaceBuilderConfig.CODEC);

	public PlanetSurfaceBuilder(Codec<SurfaceBuilderConfig> p_i232124_1_) {
		super(p_i232124_1_);
	}
