...
public interface IMesh {
	...
	static final float RESCALE_22_5 = 1.0F / (float) Math.cos((double) ((float) Math.PI / 8F)) - 1.0F;
	static final float RESCALE_45 = 1.0F / (float) Math.cos((double) ((float) Math.PI / 4F)) - 1.0F;

	public default BakedQuad bakeQuad(Vector3f from, Vector3f to, MeshFace face, TextureAtlasSprite tex, Direction dir,
	...
	default void applyElementRotation(Vector3f p_254412_, @Nullable BlockElementRotation p_254150_) {
		if (p_254150_ != null) {
			...
			this.rotateVertexBy(p_254412_, new Vector3f((Vector3fc) p_254150_.origin()),
