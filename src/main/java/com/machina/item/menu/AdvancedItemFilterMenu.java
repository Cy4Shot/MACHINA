...
public class AdvancedItemFilterMenu extends ItemMenu {
	...
	public Consumer<ItemStack> insertItemFilter(int slot) {
		return (stack) -> {
			...
			this.stack = AdvancedItemFilterItem.set(this.stack, items, null);
	...
	public void toggleMode() {
		...
		this.stack = AdvancedItemFilterItem.set(stack, null, mode.opposite());
		this.containerChanged();
	}

	public NonNullList<Item> getCurrentFilter() {
		return AdvancedItemFilterItem.getItems(stack);
	}
