...
public record OnlyPlaceOnModifier(BlockState state) implements PlacementModifier {

	public static final Codec<OnlyPlaceOnModifier> CODEC = BlockState.CODEC.fieldOf("block")
			.xmap(OnlyPlaceOnModifier::new, OnlyPlaceOnModifier::state).codec();
