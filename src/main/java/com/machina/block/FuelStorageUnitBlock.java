...
public class FuelStorageUnitBlock extends HorizontalFacingBlock {

	public FuelStorageUnitBlock() {
	...
	public TileEntity createTileEntity(BlockState state, IBlockReader world) {
		return TileEntityInit.FUEL_STORAGE_UNIT.get().create();
	}
	...
	public ActionResultType use(BlockState pState, World level, BlockPos pos, PlayerEntity player, Hand pHand,
		...
		if (!level.isClientSide()) {
			...
			if (te instanceof FuelStorageUnitTileEntity)
				NetworkHooks.openGui((ServerPlayerEntity) player, (FuelStorageUnitTileEntity) te, pos);
		}
