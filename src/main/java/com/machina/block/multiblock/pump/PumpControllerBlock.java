...
public class PumpControllerBlock extends HorizontalMultiblockBlock {

	public PumpControllerBlock() {
	...
	public TileEntityType<?> getTE() {
		return TileEntityInit.PUMP_CONTROLLER.get();
	}
	...
	public ActionResultType use(BlockState pState, World level, BlockPos pos, PlayerEntity player, Hand hand,
		...
		if (!level.isClientSide()) {
			...
			BlockHelper.openGui(level, pos, player, PumpControllerTileEntity.class);
		}
		return ActionResultType.SUCCESS;
	}
}