...
public class FissionReactorEnergyPortBlock extends MultiblockBlock {

	public FissionReactorEnergyPortBlock(Properties props) {
		super(props);
	}
	...
	public Class<? extends MachinaBlockEntity> getBlockEntityClass() {
		return FissionReactorEnergyPortBlockEntity.class;
	}

	@Override
	public BlockEntityType<?> getBlockEntityType() {
		return BlockEntityInit.FISSION_REACTOR_ENERGY_PORT.get();
	}
	...
	protected MapCodec<? extends HorizontalDirectionalBlock> codec() {
		return simpleCodec(FissionReactorEnergyPortBlock::new);
	}
}
