...
public record ConnectorModel(boolean isAmbientOcclusion, boolean isGui3d, boolean useBlockLight,
                             Function<Material, TextureAtlasSprite> spriteGetter,
                             String type) implements IDynamicBakedModel {
