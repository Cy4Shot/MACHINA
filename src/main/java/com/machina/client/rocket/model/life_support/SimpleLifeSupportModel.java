	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition LifeSupport = partdefinition.addOrReplaceChild("LifeSupport",
				CubeListBuilder.create().texOffs(0, 52)
						.addBox(-16.0F, -60.0F, -16.0F, 32.0F, 4.0F, 32.0F, new CubeDeformation(0.0F)).texOffs(0, 0)
						.addBox(-24.0F, -16.0F, -24.0F, 48.0F, 4.0F, 48.0F, new CubeDeformation(0.0F)).texOffs(0, 88)
						.addBox(12.0F, -56.0F, -12.0F, 4.0F, 40.0F, 24.0F, new CubeDeformation(0.0F)).texOffs(56, 88)
						.addBox(-16.0F, -56.0F, -12.0F, 4.0F, 40.0F, 24.0F, new CubeDeformation(0.0F)).texOffs(112, 88)
						.addBox(-16.0F, -56.0F, -16.0F, 32.0F, 40.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(112, 132)
						.addBox(-16.0F, -56.0F, 12.0F, 32.0F, 40.0F, 4.0F, new CubeDeformation(0.0F)),
				PartPose.offset(0.0F, 36.0F, 0.0F));

		PartDefinition Corners = LifeSupport.addOrReplaceChild("Corners", CubeListBuilder.create(),
		...
		PartDefinition Corner_r1 = Corners.addOrReplaceChild("Corner_r1",
				...
				PartPose.offsetAndRotation(-20.0F, -16.0F, 22.0F, -0.1745F, 0.0F, 0.1745F));
		...
		PartDefinition Corner_r3 = Corners.addOrReplaceChild("Corner_r3",
				CubeListBuilder.create().texOffs(16, 152).addBox(-3.0F, -34.0F, -44.0F, 4.0F, 44.0F, 4.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(22.0F, -16.0F, 22.0F, -0.1745F, 0.0F, -0.1745F));
