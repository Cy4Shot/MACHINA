...
public class CustomShapedRecipeBuilder {
	...
	public CustomShapedRecipeBuilder(IItemProvider pResult, int pCount) {
		this.result = pResult.asItem();
		this.count = pCount;
	}

	public static CustomShapedRecipeBuilder shaped(IItemProvider pResult) {
		return shaped(pResult, 1);
	}

	public static CustomShapedRecipeBuilder shaped(IItemProvider pResult, int pCount) {
		return new CustomShapedRecipeBuilder(pResult, pCount);
	}

	public CustomShapedRecipeBuilder define(Character pSymbol, ITag<Item> pTag) {
		return this.define(pSymbol, Ingredient.of(pTag));
	}

	public CustomShapedRecipeBuilder define(Character pSymbol, IItemProvider pItem) {
	...
	public CustomShapedRecipeBuilder unlockedBy(String p_200465_1_, ICriterionInstance p_200465_2_) {
		this.advancement.addCriterion(p_200465_1_, p_200465_2_);
		return this;
	}

	public CustomShapedRecipeBuilder group(String p_200473_1_) {
	...
	public void save(Consumer<IFinishedRecipe> p_200467_1_, ResourceLocation p_200467_2_) {
		...
		p_200467_1_.accept(new CustomShapedRecipeBuilder.Result(p_200467_2_, this.result, this.count,
