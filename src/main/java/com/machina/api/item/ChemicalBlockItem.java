...
public class ChemicalBlockItem extends BlockItem {
	...
	public ChemicalBlockItem(Block block, Properties pProperties, String toolTipKey, String chem) {
	...
	public ChemicalBlockItem(Block block, Properties pProperties, String chem) {
		super(block, pProperties);
