...
public class FissionReactorCasingBlock extends MultiblockBlock {

	public FissionReactorCasingBlock(Properties props) {
		super(props);
	}
	...
	protected MapCodec<? extends HorizontalDirectionalBlock> codec() {
		return simpleCodec(FissionReactorCasingBlock::new);
	}
}
