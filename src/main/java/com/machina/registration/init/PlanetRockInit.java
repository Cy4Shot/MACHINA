...
import com.machina.world.feature.rock.ArchRock;
import com.machina.world.feature.rock.FloatingIslandRock;
import com.machina.world.feature.rock.OreDepositRock;
...
public class PlanetRockInit {
	public static final DeferredRegister<RockMaker> ROCKS = DeferredRegister.create(RegistryInit.ROCK, Machina.MOD_ID);

	//@formatter:off
	public static final Supplier<OreDepositRock> ORE_DEPOSIT = ROCKS.register("ore_deposit", OreDepositRock::new);
	...
	public static final Supplier<ArchRock> ARCH = ROCKS.register("arch", ArchRock::new);
	//@formatter:on
}
