...
public class FissionReactorSteamPortBlock extends MultiblockBlock {

	public FissionReactorSteamPortBlock(Properties props) {
		super(props);
	}
	...
	public Class<? extends MachinaBlockEntity> getBlockEntityClass() {
		return FissionReactorSteamPortBlockEntity.class;
	}

	@Override
	public BlockEntityType<?> getBlockEntityType() {
		return BlockEntityInit.FISSION_REACTOR_STEAM_PORT.get();
	}
	...
	protected MapCodec<? extends HorizontalDirectionalBlock> codec() {
		return simpleCodec(FissionReactorSteamPortBlock::new);
	}
}
