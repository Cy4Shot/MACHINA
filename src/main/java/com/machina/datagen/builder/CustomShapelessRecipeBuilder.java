...
public class CustomShapelessRecipeBuilder {
	...
	public CustomShapelessRecipeBuilder(IItemProvider pResult, int pCount) {
	...
	public void save(Consumer<IFinishedRecipe> p_200485_1_, ResourceLocation p_200485_2_) {
		...
		p_200485_1_.accept(new CustomShapelessRecipeBuilder.Result(p_200485_2_, this.result, this.count,
