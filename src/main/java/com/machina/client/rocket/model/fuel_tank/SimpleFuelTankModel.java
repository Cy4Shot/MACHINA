...
public class SimpleFuelTankModel extends RocketPartModel {
	...
	public static LayerDefinition createBodyLayer() {
		...
		PartDefinition Reactor = partdefinition.addOrReplaceChild("Reactor", CubeListBuilder.create().texOffs(0, 192)
				.addBox(-12.0F, -72.0F, -12.0F, 24.0F, 24.0F, 24.0F, new CubeDeformation(0.0F)),
				PartPose.offset(0.0F, 60.0F, 0.0F));

		PartDefinition Sides = Reactor.addOrReplaceChild("Sides",
				CubeListBuilder.create().texOffs(0, 0)
						.addBox(-24.0F, -84.0F, -24.0F, 48.0F, 4.0F, 48.0F, new CubeDeformation(0.0F)).texOffs(0, 52)
						.addBox(-24.0F, -40.0F, -24.0F, 48.0F, 4.0F, 48.0F, new CubeDeformation(0.0F)).texOffs(0, 104)
						.addBox(20.0F, -80.0F, -24.0F, 4.0F, 40.0F, 48.0F, new CubeDeformation(0.0F)).texOffs(104, 104)
						.addBox(-24.0F, -80.0F, -24.0F, 4.0F, 40.0F, 48.0F, new CubeDeformation(0.0F)).texOffs(192, 0)
						.addBox(-20.0F, -80.0F, -24.0F, 40.0F, 40.0F, 4.0F, new CubeDeformation(0.0F)).texOffs(192, 44)
						.addBox(-20.0F, -80.0F, 20.0F, 40.0F, 40.0F, 4.0F, new CubeDeformation(0.0F)),
				PartPose.offset(0.0F, 0.0F, 0.0F));

		PartDefinition Corner1 = Sides.addOrReplaceChild("Corner1", CubeListBuilder.create(),
				PartPose.offset(0.0F, 0.0F, 0.0F));

		Corner1.addOrReplaceChild("Angle2_r1",
				CubeListBuilder.create().texOffs(112, 192).addBox(-2.0F, -22.0F, -37.0F, 4.0F, 30.0F, 4.0F,
						new CubeDeformation(0.0F)),
				PartPose.offsetAndRotation(22.0F, -40.0F, 22.0F, -1.0036F, 0.7854F, 0.0F));
