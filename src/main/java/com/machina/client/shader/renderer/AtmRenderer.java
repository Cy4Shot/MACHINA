...
public enum AtmRenderer {
	...
	private void render(final Matrix4f viewMatrix, final Matrix4f projectionMatrix) {
		...
		ShaderHandler.ATM.setUniform("invViewMat", invertedViewMatrix);
	...
	private void createDepthCopyFramebuffer() {
		...
		ShaderHandler.ATM.setSampler("depthTex", depthCopyDepthBuffer);
	}

	private void deleteDepthCopyFramebuffer() {
		ShaderHandler.ATM.setSampler("depthTex", 0);
