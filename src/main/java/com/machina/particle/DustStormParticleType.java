...
public class DustStormParticleType extends ParticleType<DustStormParticleType.DustStormParticleOptions> {
	...
	public static class DustStormParticleOptions implements ParticleOptions {

		public static final MapCodec<DustStormParticleOptions> CODEC = MapCodec.unit(new DustStormParticleOptions());

		public static final StreamCodec<ByteBuf, DustStormParticleOptions> STREAM_CODEC = StreamCodec
				.unit(new DustStormParticleOptions());

		public DustStormParticleOptions() {
		}
