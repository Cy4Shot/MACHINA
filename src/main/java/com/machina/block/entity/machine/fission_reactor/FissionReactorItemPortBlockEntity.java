...
public class FissionReactorItemPortBlockEntity extends MultiblockPartBlockEntity {

	public FissionReactorItemPortBlockEntity(BlockPos pos, BlockState state) {
		super(BlockEntityInit.FISSION_REACTOR_ITEM_PORT.get(), pos, state);
	}
	...
	public boolean isPort(MachinaCap cap) {
		return cap.equals(MachinaCap.ITEM);
	}
