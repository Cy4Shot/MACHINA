package com.machina.util.math.sdf;
...
public abstract class SDF {
	...
	public void fillRecursive(ISeedReader world, BlockPos start) {
	...
	public void fillArea(ISeedReader world, BlockPos center, AxisAlignedBB box) {
		Map<BlockPos, PosInfo> mapWorld = Maps.newHashMap();
		Map<BlockPos, PosInfo> addInfo = Maps.newHashMap();
	...
	public void fillRecursiveIgnore(ISeedReader world, BlockPos start, Function<BlockState, Boolean> ignore) {
		Map<BlockPos, PosInfo> mapWorld = Maps.newHashMap();
		Map<BlockPos, PosInfo> addInfo = Maps.newHashMap();
		Set<BlockPos> blocks = Sets.newHashSet();
		Set<BlockPos> ends = Sets.newHashSet();
	...
	public Set<BlockPos> getPositions(ISeedReader world, BlockPos start) {
		Set<BlockPos> blocks = Sets.newHashSet();
		Set<BlockPos> ends = Sets.newHashSet();
		Set<BlockPos> add = Sets.newHashSet();
		ends.add(new BlockPos(0, 0, 0));
