...
public class AdvancedItemFilterScreen extends MachinaMenuScreen<AdvancedItemFilterMenu> implements IFilteredScreen {
	...
	protected void renderBg(@NotNull GuiGraphics gui, float pt, int mx, int my) {
		...
		// Top Text
        // Swackyy: There is a duplicate check here (few lines down) as to not change draw order.
        // If this is found to not cause problems, both 'mode' related calls should be moved here
        if (mode != null) {
		...
		// Toggle Blacklist
        // Swackyy: Other conditional relating to the comment above
        if (mode != null) {
