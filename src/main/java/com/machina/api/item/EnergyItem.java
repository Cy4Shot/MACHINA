...
public abstract class EnergyItem extends Item {
	...
	public void appendHoverText(@NotNull ItemStack stack, TooltipContext context, List<Component> tooltip,
		...
		tooltip.add(Component.literal(StringUtils.formatPower(stack.get(DataComponentsInit.ENERGY)) + " / "
				+ StringUtils.formatPower(getMaxEnergy())).setStyle(Style.EMPTY.withColor(MUI.CYAN)));
