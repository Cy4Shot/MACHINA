...
public class GeothermalGeneratorCasingBlock extends MultiblockBlock {

	public GeothermalGeneratorCasingBlock(Properties props) {
		super(props);
	}
	...
	protected MapCodec<? extends HorizontalDirectionalBlock> codec() {
		return simpleCodec(GeothermalGeneratorCasingBlock::new);
	}
}
