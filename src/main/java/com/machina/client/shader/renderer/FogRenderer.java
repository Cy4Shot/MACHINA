...
public enum FogRenderer {
	...
	private void render(final Matrix4f viewMatrix, final Matrix4f projectionMatrix) {
		...
		ShaderHandler.FOG.setUniform("invViewMat", invertedViewMatrix);
	...
	private void createDepthCopyFramebuffer() {
		...
		ShaderHandler.FOG.setSampler("depthTex", depthCopyDepthBuffer);
	}

	private void deleteDepthCopyFramebuffer() {
		ShaderHandler.FOG.setSampler("depthTex", 0);
