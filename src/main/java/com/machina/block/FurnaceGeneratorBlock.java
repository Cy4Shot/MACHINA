...
public class FurnaceGeneratorBlock extends HorizontalFacingBlock {
	...
	public TileEntity createTileEntity(BlockState state, IBlockReader world) {
		return TileEntityInit.FURNACE_GENERATOR.get().create();
	}
	...
	public ActionResultType use(BlockState pState, World level, BlockPos pos, PlayerEntity player, Hand pHand,
		...
		if (!level.isClientSide()) {
			...
			if (te instanceof FurnaceGeneratorTileEntity)
				NetworkHooks.openGui((ServerPlayerEntity) player, (FurnaceGeneratorTileEntity) te, pos);
		}
